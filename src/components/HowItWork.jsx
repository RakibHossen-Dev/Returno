...
const HowItWork = () => {
  return (
    <div className=" my-10 bg-teal-50 py-10">
      <div className="w-11/12 mx-auto ">
        ...
        <div className="flex lg:flex-row flex-col justify-between items-center gap-5 mt-5">
          ...
          <div className="lg:w-1/2">
            ...
            <p>
              Create an account to track your posts and connect with others.
            </p>
            ...
            <p>
              Our system helps you find potential matches. Contact the other
              party securely, finalize details, and ensure the item gets back to
              its rightful owner.
            </p>
            ...
            <p>
              Your contribution to the community matters. Share your success
              story and inspire others to use Returno for a positive impact.
            </p>
          </div>
        </div>
      </div>
